//
//  UICollectionView+SMFooterManager.m
//  qwlg
//
...
#import "UICollectionView+SMFooterManager.h"
#import "MJRefresh.h"
#import <objc/runtime.h>

@implementation UICollectionView (SMFooterManager)
...
+ (void)load {
    ...
    dispatch_once(&onceToken, ^{
        ...
        swizzlesMethod(targetClass, originalSelector, swizzledSelector);
    });
}


void swizzlesMethod(Class class, SEL originalSelector, SEL swizzledSelector) {
